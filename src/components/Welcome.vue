<template>
  <div>
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel">
          ...
          <div class="card-panel-description">
            ...
            <count-to :start-val="0" :end-val="num1" :duration="2600" class="card-panel-num" />
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel">
          ...
          <div class="card-panel-description">
            ...
            <count-to :start-val="0" :end-val="num2" :duration="3000" class="card-panel-num" />
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel">
          ...
          <div class="card-panel-description">
            ...
            <count-to :start-val="0" :end-val="num3" :duration="3200" class="card-panel-num" />
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel">
          ...
          <div class="card-panel-description">
            ...
            <count-to :start-val="0" :end-val="num4" :duration="3600" class="card-panel-num" />
          </div>
        </div>
      </el-col>
    </el-row>
    <el-row :gutter="24">
      <el-col :span="8">
        <el-card>
          <el-button class="btn" @click="changeTimer" size="mini">选择时间</el-button>
          <div class="timer">
            <el-date-picker v-model="value" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" @change="chooseTime1" size="mini" value-format="yyyy-MM-dd" v-show="showTime">
            </el-date-picker>
          </div>
      ...
      <el-col :span="8">
        <el-card>
          <el-button class="btn1" @click="changeTimer1" size="mini">选择时间</el-button>
          <div class="timer1">
            <el-date-picker v-model="value2" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" @change="chooseTime2" size="mini" value-format="yyyy-MM-dd" v-show="showTime1">
            </el-date-picker>
          </div>
      ...
      <el-col :span="8">
        <el-card>
          <el-button class="btn" @click="changeTimer2" size="mini">选择时间</el-button>
          <div class="timer2">
            <el-date-picker v-model="value1" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" @change="chooseTime" size="mini" value-format="yyyy-MM-dd" v-show="showTime2">
            </el-date-picker>
          </div>
    ...
    <el-row :gutter="40">
      <el-col>
        <el-card>
          <el-button class="btn2" size="medium" @click="getCountDay">天</el-button>
          <el-button class="btn3" size="medium" @click="getCountMonth">月</el-button>
          <el-button class="btn4" size="medium" @click="getCountYear">年</el-button>
          <div id="countSalesByDays" style="width:100%; height:100%" v-show="showCountSalesByDays"></div>
    ...
    <el-card>
      <el-table :data="operationList" style="width: 100%" :cell-style="styleChange" border stripe max-height="520">
        <el-table-column label="序号" type="index"></el-table-column>
        <el-table-column prop="usernameCn" label="操作人" width="100">
          <el-table-column prop="usernameCn">
            <template slot="header" slot-scope="{}">
              <el-input v-model.trim="operationListSearch.usernameCn" clearable size="mini" placeholder="搜索..." @change="getOperitionList" />
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column prop="createTime" label="操作时间" width="180">
          <el-table-column width="172px" prop="createTime">
            <template slot="header" slot-scope="{}">
              <el-date-picker v-model.trim="operationListSearch.createTime" style="width:150px" clearable size="mini" type="date" value-format="yyyy-MM-dd" placeholder="选择日期" @change="getOperitionList" />
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column prop="content" label="操作内容">
          <el-table-column min-width="270px" prop="content" show-overflow-tooltip>
            <template slot="header" slot-scope="{}">
              <el-input v-model.trim="operationListSearch.content" clearable size="mini" placeholder="搜索..." @change="getOperitionList" />
            </template>
          </el-table-column>
        </el-table-column>
        <el-table-column align="center" label="操作类别" width="180px">
          <el-table-column prop="operationType" width="180px" :formatter="typeFormatter">
            <template slot="header" slot-scope="{}">
              <el-select v-model.trim="operationListSearch.operationType" placeholder="搜索..." size="mini" @change="getOperitionList">
      ...
      <div class="block">
        <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="queryInfo.currPage" :page-sizes="[6, 8, 10, 20]" :page-size="queryInfo.pageSize" layout="total, sizes, prev, pager, next, jumper" :total="total">
        </el-pagination>
      </div>
    </el-card>
  </div>
    ...
    methods: {
      ...
      async getOperitionList() {
        ...
        const { data: res } = await this.$http.post(
          ...
          this.operationListSearch, { params: this.queryInfo }
        );
        if (res.code != 200) {
      ...
      async getCountMonth() {
        ...
        let myChart = this.$echarts.init(document.getElementById('countSalesByMonth'));
        let option = {
          tooltip: {
            trigger: 'axis',
            axisPointer: { type: 'cross' }
      ...
      async getCountYear() {
        ...
        let myChart = this.$echarts.init(document.getElementById('countSalesByYear'));
        let option = {
          tooltip: {
            trigger: 'axis',
            axisPointer: { type: 'cross' }
